        ...
        <div className='flex flex-1'>
          <Link to={'/'} className='flex items-center gap-2'>
            ...
            <div className='flex flex-col'>
              <span className='block font-extrabold text-2xl tracking-[1px]'>
                <span className='text-solid'>C</span>and<span className='text-solid'>R</span>iya 
              </span>
              <span className='block font-extrabold text-xl tracking-[0.1px] text-solid -mt-1'>FooD HevaN</span>
            </div>
          </Link>
        </div>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center border pl-4 gap-2 bg-solid/10 border-gray-500/30 h-[46px] rounded-full overflow-hidden max-w-md w-full mt-6'>
                        ...
                        <button className='btn-solid font-medium Ipx-3.5 py-2 mr-0.5'>
                            Subscribe
                        </button>
                    </div>
                </div>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="">CR Food Hevan</a>. All rights reserved.</p>
